...
const MenusData = [
  { id: 1, title: "Fresh Red Apples", link: "/", price: "$2.00", img: Fruit1, delay: 0.3 },
  { id: 2, title: "Fresh Oranges", link: "#", price: "$1.00", img: Fruit2, delay: 0.6 },
  { id: 3, title: "Fresh Avocado", link: "#", price: "$4.00", img: Fruit3, delay: 0.9 },
  { id: 4, title: "Fresh Cherries", link: "#", price: "$3.00", img: Fruit4, delay: 1.2 },
];

const Menus = () => {
  return (
    <section>
      <div className="container max-w-7xl mx-auto px-8 pt-12 pb-20">
        <motion.h1
          ...
          {MenusData.map((menu) => (
            ...
            >
              <img
                src={menu.img}
                alt=""
                className="w-[60px] mb-4 scale-110 -translate-y-6"
              />
              <div>
